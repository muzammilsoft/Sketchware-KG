...
public class ProjectLibraryBean implements Parcelable {
    ...
    public static final int PROJECT_LIB_TYPE_SUPABASE = 8;
    ...
    public static int getLibraryIcon(int i) {
        return switch (i) {
            ...
            case 8 -> R.drawable.ic_mtrl_firebase_rtdb; // using Firebase RTDB icon for Supabase as a safe fallback drawable
            default -> 0;
        };
    }
